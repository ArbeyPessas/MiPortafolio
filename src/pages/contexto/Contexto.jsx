...
function Contexto() {
  const images = [{ src: img1, alt: 'Campus universitario' },
  ...
  return (
    <section className="contexto-page">
      ...
      >
        ...
        <p>
          El producto multimedia se entrega en el campus como “Entregue Producto audiovisual: Recorriendo la Univalle”.
        </p>
      </InfoCard>
      ...
      <section className="wide-text">
        <h2>Reflexión</h2>
        <p>
          Durante el recorrido por la Universidad pude identificar la riqueza del campus como espacio
          de aprendizaje y convivencia. Mi lugar favorito fue la biblioteca y sus zonas de estudio,
          donde se percibe un ambiente propicio para la concentración y el trabajo colaborativo.
          ...
          importancia de los espacios físicos en el desempeño académico y la necesidad de involucrarnos
          en su cuidado como comunidad universitaria.
        </p>
      </section>
